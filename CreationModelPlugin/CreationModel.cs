...
namespace CreationModelPlugin
{
    ...
    public class CreationModelPlugin : IExternalCommand
    {
        ...
        public static void GetWallDrawMethod(Document doc, Level level1, Level level2)
        {
            ...
            List<XYZ> pointcentertlist = new List<XYZ>();
            for (int c = 1; c < 4; c++)
            {
        ...
        private static void AddWindow(Document doc, Level level1, Wall wall)
        {
            ...
            FamilyInstance familyInstance = doc.Create.NewFamilyInstance(pointw, windowType, wall, level1, StructuralType.NonStructural);
        }
